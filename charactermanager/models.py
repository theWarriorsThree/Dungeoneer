...
class Ability(models.Model):
    ...
    attackStatNote = models.CharField(max_length=64,blank=True)
    defenseStat = models.CharField(max_length=64,choices=DEFENSE_STAT_CHOICES, default='EMPTY',blank=True)
    defenseStatNote = models.CharField(max_length=64,blank=True)
    ...
    sustainNote = models.CharField(max_length=64,blank=True)
